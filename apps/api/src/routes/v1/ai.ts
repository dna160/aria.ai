...
import { getLLMClient } from '@aria/ai';
...
import {
  ...
  buildFlowModPrompt,
  computeRiskScore,
} from '@aria/flow-engine';
import type { FlowDefinition } from '@aria/flow-engine';
...
export const aiRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.post<{
    ...
    async (request, reply) => {
      ...
      const llm = getLLMClient();
      const systemPrompt = [
        'You are a helpful business assistant for Aria, a WhatsApp commerce automation platform.',
