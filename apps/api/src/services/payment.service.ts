 ...
 * Imports : @aria/shared, @aria/db, @aria/payments, @aria/meta
 * Exports : PaymentService class
 */
import { Queue } from 'bullmq';
import { db, conversations, orders, buyers, products } from '@aria/db';
import { eq, and } from '@aria/db';
import type { MetaClient } from '@aria/meta';
import { MidtransProvider, XenditProvider } from '@aria/payments';
import { QUEUES } from '@aria/shared';
import { config, getRedisConnection } from '../config';
import { InventoryService } from './inventory.service';
import { getTenantMetaClient } from './_meta.helper';
import type { IPaymentProvider } from '@aria/payments';
