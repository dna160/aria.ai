    ...
    <div>
      ...
      {mode === 'choose' && (
        <div className="space-y-3">
          ...
          >
            <p className="text-white font-medium">Use Aria Number</p>
      ...
      {mode === 'pool' && status !== 'ok' && (
        <div className="space-y-4">
          <div className="bg-[#0F172A] border border-[#334155] rounded-lg px-4 py-3">
            <p className="text-slate-300 text-sm">Aria will assign you a pre-verified WhatsApp Business number. Click <strong>Activate</strong> to continue.</p>
          </div>
