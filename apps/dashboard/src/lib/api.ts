...
export interface Tenant {
  ...
  wabaStatus: 'pending' | 'registering' | 'pending_verification' | 'active' | 'suspended' | 'manual_required';
...
export const onboardingApi = {
  ...
  status: () =>
    api.get<{ onboarded: boolean; displayPhone: string | null; wabaStatus: string }>('/onboarding/status'),
};
