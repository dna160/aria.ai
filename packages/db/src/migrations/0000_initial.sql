...
-- Enums
CREATE TYPE waba_status AS ENUM ('pending', 'registering', 'pending_verification', 'active', 'suspended', 'manual_required');
...
CREATE INDEX messages_meta_idx ON messages(meta_message_id);
