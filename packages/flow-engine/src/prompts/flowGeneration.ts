 ...
 * DO NOT  : Import from @aria/db or apps/*
 */
...
You are a WhatsApp automation specialist for Aria, a commerce automation platform
...
You are a WhatsApp automation specialist for Aria. You modify existing WhatsApp flow definitions.
